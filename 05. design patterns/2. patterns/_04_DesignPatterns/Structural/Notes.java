package _04_DesignPatterns.Structural;
...
/*
    ...
    - Structural design patterns:
        ...
        - Structural design patterns help to achieve several important goals in software development
            ...
            2. Enhance flexibility and extensiblity by allowing the system's structure to evolve without requiring major changes to the exisiting code. This is achieved by decoupling the components of the system and promoting loose coupling between different parts
            3. Improve performance and resource utilization by optimizing the way objects interact and collaborate within the system, thereby enhancing overall system efficiency

        - Overall, these patterna contribute to building robust, adaptable and well-organized software systems that are easier to understand, maintain and extend over time
