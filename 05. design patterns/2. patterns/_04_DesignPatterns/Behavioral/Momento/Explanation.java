...
/*
    ...
    - SOLUTION:
        - EditorState class: Memento
            ...
            - We added a meta data field **createdAt** which enables us take the exact moment an EditorState instance was created. It gives little information if needed later
        ...
        - Editor class: Originator
            - Our Editor class has title and content field
            ...
            - We also create createState() and restore() methods
        ...
        - History class: Caretaker
            - Here we store a list of all the previous Editor(Originator) states
