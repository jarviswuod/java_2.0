...
/*
    ...
    - Liskov Substitution principle:
        - It states that whenever we are creating a parent-child relationship, the sub-classes should be substitutable without breaking the program’s correctness
    ...
    - BAD EXAMPLE EXPLANATION:
        ...
        - Concrete classes:
            - HomeLoan class:
                - HomeLoan implements LoanPayment and overrides all the methods; doPayment(), forCloseLoan(), doRepayment() with no issue
