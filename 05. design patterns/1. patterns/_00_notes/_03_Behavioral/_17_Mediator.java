...
/*
    ...
    - 4 Main actors in Mediator;
        ...
        c. Component:
            - Is an interface that defines the communication methods that concrete components must implement
            - It maintains a reference to the mediator
    ...
    - Advantages and Disadvantages
        - Advantages:
            - Decoupling and centralized control: It promotes loose coupling and easier maintenance by reducing direct dependencies between components. This centralized control helps manage complex interactions and avoid tangled relationships among components
            - Enhanced extensibility: Adding new components or chaining interaction patterns becomes easier with modifications being localized to the mediator enhancing extensibility
