...
/*
    ...
    NOTES:
    - Interpreter Pattern:
        - Is a behavior pattern that provides a way to evaluate sentences or languages in a language
        - It defines it's language and grammar in terms of a set of classes where each class represents a rule or production of the language. This is useful for creating an interpreter for a simple language or expression such as regular expression, mathematical expressions or domain specific languages
