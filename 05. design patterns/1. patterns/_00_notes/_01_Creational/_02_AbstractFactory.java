...
/*
    ...
    - Advantages and Disadvantages
        - Advantages:
            - Consistency: It promotes consistency by ensuring that products generated by the factory are compatible and consistent with each other
            ...
            - Flexibility: It offers flexibility as you can easily introduce new product families by creating new concrete Factory classes without changing existing client code
            - Loose coupling: It encourages separation, Clients rely on the abstract interfaces of factories and products which reduces dependency on concrete classes


        - Disadvantages:
            - Complexity: It introduces increased complexity to the code base particularly when managing multiple factories and products families. As more type of product and factories are added, the number of classes and interactions can grow substantially potentially making the code harder to understand and maintain
            - Limited Scope: It's most suitable when dealing with a specific set of related product families. If the application requires creation of individual objects with unique characteristics, other creation patterns like Factory Method or Builder might be more appropriate
