...
/*
    ...
    - Singleton Pattern:
        ...
        - It ensures that a single instance of a class is created and shared through out the life of the application preventing multiple instances creation


    - 1 Main actor in Singleton Design Pattern:
        a. Singleton:
