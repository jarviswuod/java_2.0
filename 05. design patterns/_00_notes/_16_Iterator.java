/*
    ...
    - Advantages and Disadvantages
        - Advantages:
            ...
            - Iterating complex structure: The pattern has the ability to handle iterating over comples data structures, this ensures the complexities involved do not burden the client allowing them to concentrate solely on there tasks
            - Multiple Iterators: The pattern supports the implementation of multiple iterators on the same collection, each providing a unisue perspective of traversal. This feature is handy when different views or traversals of teh data are required


        - Disadvantages:
            - Limited Fuctionality: The iterator provides just a basic set of traversal methods, this limitation is insufficient to cover all potetential use cases that may arise
            - Code overhead: The need to implement custom iterators and aggregators can lead to additional complexity in the code. This becomes expecially visible in simple scenarios where such complexity may not be justified
