/*
    ...
    - A deque can be used as FIFO queue, where elements added at tail are presented at the head for inspection or removal in the same order, thus implementing FIFO Order
...
/*
    ...
    - Whenever you want to implement LIFO order, ArrayDeque class is always the way to go(Stack)
    - Whenever you need a normal queue, FIFO order, LinkedList works perfect
