public class _18_StringsInJava {
    public static void main(String[] args) {

        String name = "Jarvis";

        // To get all String methods just do name(dot) -> name.
        System.out.println(name.length());

        StringBuffer sb = new StringBuffer("Wuod");

        // To get all StringBuffer methods just do sb(dot) -> sb.
...
// System.out.println("s1 == s3: " + (s1 == s3)); // true - compile-time
// optimization
// System.out.println("s1 == s4: " + (s1 == s4)); // false - different objects
// System.out.println("s4 == s5: " + (s4 == s5)); // false - different heap
// objects
// System.out.println("s1 == s6: " + (s1 == s6)); // false - runtime
// concatenation
// System.out.println("s1 == s7: " + (s1 == s7)); // true - intern() returns
// pool reference
...
// for (int i = 0; i < 10; i++) {
// sb2.append("x");
// System.out.println("Length: " + sb2.length() + ", Capacity: " +
// sb2.capacity());
// }
...
// System.out.println("Before trimToSize - Capacity: " + sb3.capacity() + ",
// Length: " + sb3.length());
// sb3.trimToSize();
...
// System.out.println("\nAlternative: External synchronization on
// StringBuilder");
...
// System.out.println("\nPerformance Ratios:");
// System.out.println("StringBuilder vs String: " + (stringTime / sbTime) + "x
// faster");
// System.out.println("StringBuffer vs String: " + (stringTime / sbfTime) + "x
// faster");
// System.out.println("StringBuilder vs StringBuffer: " + (sbfTime / sbTime) +
// "x faster");
...
// StringBuilder original = new StringBuilder("The quick brown fox jumps over
// the lazy dog");
...
// System.out.println("toString() creates new objects: " + (str1 == str2)); //
// false
