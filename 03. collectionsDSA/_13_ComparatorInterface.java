/*
    ...
    - The issue in the Integer class arises, the way the compareTo() works is in ascending order. And that's why we could only get the bottom 2 elements first and not the top 2 elements. 
...
public class _13_ComparatorInterface {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("orderIntegers Start : " + orderIntegers); // orderIntegers Start : [44, 33, 22, 11]
