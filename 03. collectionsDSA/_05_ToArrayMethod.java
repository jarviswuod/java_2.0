/*
    NOTES:
      - new Integer[0] -> You can any size really
      ...
      - If you pass a small size than the ArrayList length, then a new Array is created with exactly the same length as the ArrayList, BEST PRACTISE
...
public class _05_ToArrayMethod {
